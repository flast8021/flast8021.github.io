...
function change_background() {
    ...
    let n = d.getHours();
    if (n>23 || n<=6) {
        document.querySelector(".theme-js").style.backgroungImage = "url('assets/img/dublin-night.jpg')";
    } else {
        document.querySelector(".theme-js").style.backgroungImage = "url('assets/img/dublin-day.jpg')";
    }
}
change_background();
